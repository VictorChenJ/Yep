...
NGame = {
	...
	EVENT_TIMEOUT_DEFAULT = 14,						-- Default days before an event times out if not scripted
	MISSION_REMOVE_FROM_INTERFACE_DEFAULT = 14,		-- Default days before a mission is removed from the interface after having failed or completed
...
NDiplomacy = {
	...
	BASE_IMPROVE_RELATION_COST = 5,                -- Political power cost to initiate relation improvement
	...
	ASSUME_FACTION_LEADERSHIP_PP_COST = 150,				-- Political power cost to assume faction leadership
...
NCountry = {
	...
	CONVOYS_SUNK_MULTIPLIER_FOR_WAR_SUPPORT = 0.15,	-- once a trade convoy ship sunk, you will get a larger negative impact on your war support
	CONVOYS_BEING_RAIDED_DAILY_WAR_SUPPORT_IMPACT_FROM_OVERSEA_STATES = 0.15,	-- resource transfer convoys convoys from our states being raided will give a daily war support penalty depending on how important that resource is and how inefficent convoys are
	CONVOYS_SUNK_MULTIPLIER_FOR_WAR_SUPPORT_FROM_OVERSEA_STATES = 0.15,			-- once a resource transfer convoys from our states ship sunk, you will get a larger negative impact on your war support
	CONVOYS_BEING_RAIDED_DAILY_WAR_SUPPORT_IMPACT = 0.15,	-- trade convoys being raided will give a daily war support penalty depending on how important that resource is and how inefficent convoys are
...
NTechnology = {
	...
	BASE_RESEARCH_POINTS_SAVED = 60.0,		-- Base amount of research points a country can save per slot.
...
NTrade = {
	...
	RELATION_TRADE_FACTOR = 1.35,					-- Trade factor is modified by Opinion value times this
...
NAI = {
	...
	MAIN_ENEMY_FRONT_IMPORTANCE = 5,			-- How much extra focus the AI should put on who it considers to be its current main enemy.
	EASY_TARGET_FRONT_IMPORTANCE = 6,			-- How much extra focus the AI should put on who it considers to be the easiest target.
	...
	DESPERATE_ATTACK_WITHOUT_ORG_WHEN_NO_ORG_GAIN = 140,		-- if ai can't regain enough org to attack in this many hours, it will go truly desperate and attack anyway (still has to wait for move org)
	...
	NUM_DAYS_TO_PULL_EXPEDITIONARIES_BACK = 30,					-- AI will pull units back from non-ai players after waiting this days if things are not going well for its units
	...
	START_TRAINING_EQUIPMENT_LEVEL = 0.92,               -- ai will not start to train if equipment drops below this level
	...
	MIN_INVASION_AREA_SIZE_FOR_FLOATING_HARBORS = 13,   -- AI will consider using floating harbors for naval invasion if invasion area is larger than this many provinces
	...
	MAX_MICRO_ATTACKS_PER_ORDER = 7,					-- AI goes through its orders and checks if there are situations to take advantage of was at three
...
NFocus = {
	...
	MAX_SAVED_FOCUS_PROGRESS = 40,				-- This much progress can be saved while not having a focus selected
},
...
NIntel = {
	...
	RADAR_LEVEL_INTEL_FACTOR = 1.3,					-- Multiplied to the radar level to tell the fraction of intel per covered province we get. The radar level is computed as BuildingLevel / MaxBuildingLevel.
